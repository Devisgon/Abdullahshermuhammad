...
export function AssessmentIntro() {
  return <div>
    <p className="mb-5 text-xs font-extrabold tracking-widest text-accent">FREE AI OPPORTUNITY ASSESSMENT</p>
    <h1 className="text-[clamp(2.8rem,4.5vw,4.6rem)] leading-[1.08] font-bold tracking-[-0.055em]">Find the work your team <span className="text-accent">shouldn’t have to repeat.</span></h1>
