...
export function PeopleFeature() {
  return <section className="bg-[#f3edf5] py-20 md:py-28">
    <Container className="grid items-center gap-10 md:grid-cols-2 md:gap-20">
      <div className="relative mx-auto h-[430px] w-full max-w-[520px] overflow-hidden rounded-lg bg-[#d9c8df] md:h-[550px]">
        ...
        <span className="absolute right-5 bottom-4 text-xs text-brand">Illustrative portrait</span>
      </div>
      <div>
